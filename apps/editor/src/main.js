...
const OPS = ["placeClip", "moveClip", "trimEnd", "trimStart", "slipClip", "splitClip", "deleteClip", "setText", "setVolume", "setTransform", "setOpacity", "addTrack", "addSequence", "setActiveSequence", "renameSequence", "renameTrack", "renameClip", "removeSequence", "rippleDelete", "addMarker", "removeMarker", "updateMarker", "setFade", "overwritePlace", "setKeyframe", "removeKeyframe", "setTransition", "setSpeed", "setCrop", "setBlend", "setTrackFlags", "deleteClips", "moveClips", "setTextStyle", "setTextAnim", "moveKeyframe", "duplicateClips", "linkClips", "unlinkClips"];
