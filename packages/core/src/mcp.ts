...
case 'importSubs': return importSubtitles(store, q['path'] as string);
    ...
    case 'removeSequence': return store.removeSequence(seqId as string);
    case 'duplicateSequence': return store.duplicateSequence(seqId as string, q['name'] as string | undefined);
